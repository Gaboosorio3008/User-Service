...
const DTOActualizarEmailSchema = Type.Object(
    {
...
const validateSchemaDTO = ajv.compile(DTOActualizarEmailSchema)

const ActualizarEmailDTO = (req, res, next) => {
...
export default ActualizarEmailDTO